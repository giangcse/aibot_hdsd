...
Sử dụng các Chatbot AI khác để tạo system prompt (ví dụ: [ChatGPT](https://chatgpt.com/), [Gemini](https://gemini.google.com/),...) hoặc tự viết prompt theo mục đích sử dụng. _Lưu ý: Prompt phải chứa đủ 2 biến `{context}` và `{user_question}`_
