...
1. Tạo tính năng
    ...
    ![Tạo tính năng](../images/taotinhnang.gif)

2. Sử dụng tính năng
    - Chọn tính năng đã tạo
    - Chọn file cần sử dụng
    - Nhấn nút `Chọn X tệp` (X là số file đã chọn)

    ![Sử dụng tính năng](../images/dungtinhnang.gif)
